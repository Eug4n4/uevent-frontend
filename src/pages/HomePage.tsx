...
const upcomingEvents: EventPreview[] = [
  {
    ...
    format: "Conference",
    theme: "Business",
    summary: "Quick lightning talks about “fintech-y stuff” so we have somewhere to plug Stripe later.",
    ...
    poster: "https://images.unsplash.com/photo-1475724017904-b712052c192a?auto=format&fit=crop&w=700&q=60",
    attendees: [
  ...
  },
  {
    ...
    format: "Workshop",
    theme: "Psychology",
    summary: "Role-play sessions, breathing tricks, a bit of la-la chitchat—perfect mock content for UX demos.",
    ...
    poster: "https://images.unsplash.com/photo-1489515217757-5fd1be406fef?auto=format&fit=crop&w=700&q=60",
    attendees: [
  ...
  },
  {
    ...
    format: "Fest",
    theme: "Politics",
    summary: "Food trucks, open mics, some “talk-about-the-city” panels—exactly what we need for map/demo screens.",
    ...
    poster: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=700&q=60",
    attendees: [
